      ...
      <div className="flex">
        ...
        <div className="flex-1 p-3">
          <div className="font-mono text-xs text-foreground space-y-1">
            <div>
              <span className="text-blue-400">import</span> <span className="text-yellow-400">{"{ Route }"}</span>{" "}
              <span className="text-blue-400">from</span> <span className="text-green-400">'react-router-dom'</span>
            </div>
            <div>
              <span className="text-blue-400">import</span> <span className="text-yellow-400">{"{ Route }"}</span>{" "}
              <span className="text-blue-400">from</span> <span className="text-green-400">'react-router-dom'</span>
            ...
            <div></div>
            <div>
              <span className="text-purple-400">function</span> <span className="text-yellow-400">trackProgress</span>(
              <span className="text-blue-400">user</span>) {"{"}
            </div>
            <div className="ml-4">
              <span className="text-blue-400">const</span> <span className="text-foreground">context</span> ={" "}
              <span className="text-yellow-400">useContext</span>(<span className="text-blue-400">Context</span>)
            </div>
            <div className="ml-4">
              <span className="text-blue-400">const</span> <span className="text-foreground">rating</span> ={" "}
              <span className="text-yellow-400">calculateRating</span>(<span className="text-blue-400">contests</span>,{" "}
              <span className="text-blue-400">results</span>)
            </div>
            <div className="ml-4"></div>
            <div className="ml-4">
              <span className="text-blue-400">return</span> {"{"} <span className="text-foreground">rating</span>,{" "}
